...
const AlarmPrimaryActions = ({ onClose, onViewLive }) => (
  <div className="grid grid-cols-2 gap-2.5 px-[14px]">
    <Button
      ...
      onClick={onClose}
      className="[min-height:var(--rm-alarm-action-min-height)] rounded-[var(--rm-alarm-action-radius)] px-2.5 py-3.5 text-center text-[length:var(--rm-fs-body-strong)] leading-[1.25] font-bold focus-visible:ring-0 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:[outline-color:var(--alarm-focus-outline)] active:scale-[0.99]"
    >
      On my
      <br />
      way
...
const AlarmForwardAction = ({ onFallReview }) => (
  <div className="px-[14px] pt-2.5">
    <Button
      ...
      className="flex [min-height:var(--rm-alarm-action-min-height)] w-full items-center justify-between rounded-[var(--rm-alarm-action-radius)] px-[18px] py-[13px] text-[length:var(--rm-fs-body-strong)] font-bold focus-visible:ring-0 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:[outline-color:var(--alarm-focus-outline)] active:scale-[0.99]"
    >
