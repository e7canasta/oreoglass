const IconStatusSignal = ({ fill = "var(--rm-icon-solid)" }) => (
  <svg width="18" height="13" viewBox="0 0 18 13" fill={fill}>
...
const IconStatusWifi = ({ fill = "var(--rm-icon-solid)" }) => (
  <svg width="16" height="13" viewBox="0 0 16 13" fill={fill}>
...
export { IconStatusSignal, IconStatusWifi };
